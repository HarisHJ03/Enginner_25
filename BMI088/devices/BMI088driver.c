...
//void BMI088_ACCEL_ReadData(uint32_t Address, uint8_t *DataArray, uint32_t Count)
//{
//	uint32_t i;
//	MySPI_Start();								
...
void BMI088_read(fp32 gyro[3], fp32 accel[3], fp32 *temperate)
{
	...
	BMI088_accel_read_muli_reg(BMI088_ACCEL_XOUT_L, buf, 6);//BMI088 软件要改
	BMI088_accel_read_muli_reg(BMI088_ACCEL_XOUT_L, buf_accel, 6);//软件要改
